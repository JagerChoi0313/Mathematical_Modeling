function resultTable = analyze_time_stability_v3(timeMin, conv, c4sel, figDir)
%ANALYZE_TIME_STABILITY_V3
...
exportgraphics(f, fullfile(figDir,'stability_350C_v3.png'), 'Resolution',180);
close(f);
end
